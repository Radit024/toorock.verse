...
const Footer = () => (
  <footer className="border-t border-border pb-14 md:pb-0">
    <div className="container py-4">
      <div className="flex flex-row items-center justify-between gap-2">
        <div>
          <h2 className="font-heading text-lg md:text-xl text-primary tracking-widest leading-tight">ToRock Verse</h2>
          <p className="font-meta text-[9px] text-muted-foreground uppercase tracking-wider mt-0.5">
        ...
        <div className="flex flex-col items-end gap-1.5">
          <div className="flex gap-1.5">
            ...
            <a href="https://discord.gg/FVPaZeKfX8" target="_blank" rel="noopener noreferrer"
          ...
          <p className="font-meta text-[9px] text-muted-foreground">© 2026 ToRock Verse.</p>
        </div>
      </div>
    </div>
  </footer>
